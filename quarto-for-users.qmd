...
format: 
  revealjs:
    ...
    footer: <a href="https://quarto.org">Quarto for the Curious</a> by [@thomas_mock](https://twitter.com/thomas_mock)
    slide-number: true
knitr: 
  opts_chunk: 
    echo: false
...
## We [don't]{.fragment .strike} talk about Quarto
...
::: r-stack
![](images/rmd-knitr.png){.fragment width="1500" fig-alt="diagram of converting a RMarkdown document via knitr/pandoc into markdown and then into output formats"}
...
![](images/jupyter-alone.png){.fragment width="1500" fig-alt="diagram of converting a Jupyter notebook via pandoc into markdown and then into output formats"}
:::
