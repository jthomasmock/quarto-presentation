...
format: 
  revealjs:
    ...
    footer: <a href="http://rstd.io/quarto-curious">rstd.io/quarto-curious</a> by [@thomas_mock](https://twitter.com/thomas_mock)
    slide-number: true
knitr: 
  opts_chunk: 
    echo: false
...
[`r fontawesome::fa("twitter", "white", height="45px")` @thomas_mock]{style="font-size: 60px; font-weight: bold; font-color: white;"}
...
-   RMarkdown grew into a large ecosystem, but ended up with incosistent syntax.
