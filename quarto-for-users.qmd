...
![](images/quarto-bruno.png){style="position: absolute; top: 150; left: 20px; width: 800px;" fig-alt="A tweet by Alison Hill revealing her blogpost on Quarto. Over the weekend, I wrote up my notes about using and teaching Quarto, based on my experiences  working with the development team for over a year. I think (hope?) it is safe to talk about it now"}
...
![](images/jeremy-howard-quarto.png){style="position: absolute; top: 100px; left: 20px; width: 800;"}

. . .

![](images/hamel-quarto.png){style="position: absolute; top: 100px; left: 20px; width: 1000px;"}
...
![](images/quarto-nervous.png){style="position: absolute; top: 250px; left: 20px; width: 1200px;"}

. . .

![](images/quarto-confused-2.png){style="position: absolute; top: 150; left: 20px; width: 1300px;"}
...
![](images/quarto-confused-short.png){style="position: absolute; top: 250; left: 20px; width: 1300px;" alt-text="A tweet by Erwin Lares: #RStats can someone explain to me what's the difference between Quarto and RMarkdown. I saw a tweet about Quarto and now I'm all confused ... What gap is it supposed to fill?"}
...
![](images/cocktail-diagram.png){style="position: absolute; top: 250px; left: 50px; width: 1800px;" fig-alt="diagram of converting liquor, citrus, sugar into delicious cocktails"}
...
## "Crafting" process for literate programming {background-image="images/qmd-knitr.jpeg" background-size="85%" background-position="center"}
...
![](images/qmd-knitr.png){.fragment width="1800" fig-alt="diagram of converting a Quarto document via knitr/pandoc into markdown and then into output formats" fig-align="center"}
...
- Better accessibility, richer features and interactivity out of the box
